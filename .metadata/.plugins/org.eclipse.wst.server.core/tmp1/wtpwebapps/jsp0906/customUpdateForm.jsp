...
<div class="col-lg-15 col-md-15 mx-auto">
  ...
  <div class="album py-5 bg-body-tertiary">
	...
	<form action="updateCustom.do" method="post">
	<input type="hidden" name="custcode" value="${custom.custcode}">
	<%-- <input type="hidden" name="item_birth" value="${item.item_birth}"> --%>
	<fieldset>
	<legend>거래처정보수정</legend>
	<table>
	<tr>
		<td>거래처코드:</td> <td>${custom.custcode}</td> 
   </tr>
    <tr>
    <td>거래처명:</td> <td> <input type="text" name="custname" value="${custom.custname}" required="required"></td>  
    </tr>
    <tr>
    <td>거래처tel:</td> <td> <input type="text" name="cust_tel" value="${custom.cust_tel}" required="required"></td>  
     </tr>
    <tr> 
    <td>거래처구분: </td> <td> <input type="text" name="cust_gubun" value="${custom.cust_gubun}" required="required"></td>  
    </tr>
     <tr> 
    <td>거래처대표: </td> <td> <input type="text" name="cust_ceo" value="${custom.cust_ceo}" required="required"></td>  
    </tr>
