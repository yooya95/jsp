...
<div class="col-lg-15 col-md-15 mx-auto">
  ...
  <div class="album py-5 bg-body-tertiary">
	...
	<table>
	<tr>
		<td>사번:</td> <td>${sawon.sabun}</td> 
   </tr>
    <tr>
    <td>이름:</td> <td> <input type="text" name="sawon_name" value="${sawon.sawon_name}" required="required"></td> <p>  
    </tr>
    <tr>
    <td> 급여:</td> <td>  <input type="text" name="sal" value="${sawon.sal}" required="required"></td>  <p>
     </tr>
    <tr> 
    <td>전화번호: </td> <td> <input type="text" name="handphone" value="${sawon.handphone}" required="required"></td>  <p>
    </tr>
    </table>
